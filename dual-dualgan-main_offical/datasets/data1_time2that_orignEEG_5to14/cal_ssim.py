...
for i in range(5, 76, 10):
    # 示例用法
    ssim_score = duibi(
        "E:\\dual-dualgan-main_offical\\datasets\\data1_time2that_orignEEG_5to14\\test\\C\\C_"+str(i)+".png",
        "E:\\dual-dualgan-main_offical\\datasets\\data1_time2that_orignEEG_5to14\\comparison_epoch1000_results\\test\\data1_time2that_orignEEG_5to14-img_sz_256-fltr_dim_64-L1-lambda_BC_1000.0_1000.0\\C\\B_" + str(
            i) + "_B2C.jpg",
        i,
        "./comparison_epoch1000_results")
