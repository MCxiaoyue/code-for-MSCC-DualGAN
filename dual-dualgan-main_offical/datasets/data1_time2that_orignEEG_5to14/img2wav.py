...
for i in range(5, 76, 10):
    # # 使用函数
    image_to_wav("E:\\dual-dualgan-main_offical\\test\\data1_time2that_orignEEG_5to14-img_sz_256-fltr_dim_64-L1-lambda_BC_1000.0_1000.0\\C\\B_" + str(i) + "_B2C.jpg", "./BtoC_"+str(i)+".wav")
