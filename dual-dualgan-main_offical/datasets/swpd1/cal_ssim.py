...
for i in range(91, 101):
    # 示例用法
    ssim_score = duibi(
        "E:\\dual-dualgan-main_offical\\datasets\\swpd1\\test\\C\\C_"+str(i)+".png",
        "E:\\dual-dualgan-main_offical\\test\\swpd1-img_sz_256-fltr_dim_64-L1-lambda_BC_1000.0_1000.0\\B\\B_" + str(
            i) + "_B2C.jpg",
        i,
        "./comparison_epoch250_results")
