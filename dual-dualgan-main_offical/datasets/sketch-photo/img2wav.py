...
for i in range(1, 11):
    # # 使用函数
    # image_to_wav("E:\\dual-dualgan-main_offical\\test\\sketch-photo-img_sz_256-fltr_dim_64-L1-lambda_BC_1000.0_1000.0\\C\\B_" + str(i) + "_B2C.jpg", "./BtoC_"+str(i)+".wav")
    image_to_wav("./test/C/C_"+str(i)+".jpg", "./C_" + str(i) + ".wav")