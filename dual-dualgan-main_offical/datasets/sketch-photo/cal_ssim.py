...
for i in range(1, 11):
    # 示例用法
    ssim_score = duibi(
        "E:\\dual-dualgan-main_offical\\datasets\\sketch-photo\\test\\C\\C_"+str(i)+".jpg",
        "E:\\dual-dualgan-main_offical\\\datasets\\sketch-photo\\comparison_epoch1000_results\\test\\sketch-photo-img_sz_256-fltr_dim_64-L1-lambda_BC_1000.0_1000.0\\C\\B_" + str(
            i) + "_B2C.jpg",
        i,
