...
def duibi(img_path1, img_path2, save_path):
    ...
    # # 保存比较结果
    # plt.savefig(os.path.join(save_path, f"1.jpg"))
...
# 示例用法
ssim_score = duibi(
        "E:\\new_brain2voiceDataset_official2\\sub-9\\test\\A\\A_5.png",
        "E:\\new_brain2voiceDataset_official2\\sub-9\\train\\A\\A_1.png",
