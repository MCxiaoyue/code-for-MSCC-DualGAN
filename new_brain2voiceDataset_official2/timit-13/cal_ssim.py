...
for i in range(1, 63, 10):
    # 示例用法
    ssim_score = duibi(
        "E:\\new_brain2voiceDataset_official2\\timit-13\\test\\B\\B_"+str(i)+".png",
        "E:\\new_brain2voiceDataset_official2\\timit-13\\test_AtoB_results\\AtoB_"+str(i)+".PNG",
        i,
        "./comparison_CycleGAN2_epoch250_lr0.00005and0.00001_results")
