...
for i in [5, 10, 21, 26, 37, 42, 53, 58, 69, 74]:
    # 示例用法
    ssim_score = duibi(
        "E:\\new_brain2voiceDataset_official2\\sub-5\\test\\B\\B_"+str(i)+".png",
        "E:\\new_brain2voiceDataset_official2\\sub-5\\test_AtoB_results\\AtoB_"+str(i)+".PNG",
        i,
        "./comparison_DiscoGAN2_epoch250_lr0.00005and0.00001_results")
