...
for i in range(5, 76, 10):
    # 示例用法
    ssim_score = duibi(
        "E:\\brain2voiceDataset_offical\\data1_time2that_orignEEG_5to14\\test\\B\\C_"+str(i)+".png",
        "E:\\brain2voiceDataset_offical\\data1_time2that_orignEEG_5to14\\test_AtoB_results\\AtoB_"+str(i)+".PNG",
        i,
        "./comparison_UGATIT_epoch250_lr0.00005and0.00001_results")
