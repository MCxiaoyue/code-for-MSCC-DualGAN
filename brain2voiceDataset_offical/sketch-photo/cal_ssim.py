...
for i in range(1, 11):
    # 示例用法
    ssim_score = duibi(
        "E:\\brain2voiceDataset_offical\\sketch-photo\\test\\B\\C_"+str(i)+".jpg",
        "E:\\brain2voiceDataset_offical\\sketch-photo\\test_AtoB_results\\AtoB_"+str(i)+".PNG",
        i,
        "./comparison_IncepV4_M3_epoch1000_lr0.00005and0.00001_results")
